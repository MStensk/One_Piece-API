...
public class Populate {
    ...
    public static void main(String[] args) {
        EntityManagerFactory emf = HibernateConfig.getEntityManagerFactory("onepiece");
        ...
        try (EntityManager em = emf.createEntityManager()) {
            ...
            // --- Create Pirates for each Crew ---
            List<Pirate> strawPirates = getStrawHatPirates(strawHats);
            List<Pirate> blackbeardPirates = getBlackbeardPirates(blackbeard);
            List<Pirate> redHairPirates = getRedHairPirates(redHair);

            strawHats.getPirates().addAll(strawPirates);
            blackbeard.getPirates().addAll(blackbeardPirates);
            redHair.getPirates().addAll(redHairPirates);
